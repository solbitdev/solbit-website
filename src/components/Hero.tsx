      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed animate-fade-in">
            Desarrollamos soluciones tecnológicas <span className="font-semibold text-blue-600 dark:text-blue-400">simples</span>, 
            <span className="font-semibold text-purple-600 dark:text-purple-400"> accesibles</span> y 
            <span className="font-semibold text-indigo-600 dark:text-indigo-400"> automatizadas</span> para 
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 animate-fade-in">
            ...
            <Button 
              variant="outline" 
              size="lg"
              onClick={() => document.querySelector('#sobre-nosotros')?.scrollIntoView({ behavior: 'smooth' })}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center p-6 rounded-xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all duration-300 hover:scale-105">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Tecnología Simple</h3>
              <p className="text-gray-600 dark:text-gray-400">Soluciones intuitivas que realmente funcionan</p>
            </div>
            
            <div className="text-center p-6 rounded-xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all duration-300 hover:scale-105">
              <Lightbulb className="h-12 w-12 text-purple-600 mx-auto mb-4" />
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Innovación Accesible</h3>
              <p className="text-gray-600 dark:text-gray-400">Precios justos para todos los emprendedores</p>
            </div>
            
            <div className="text-center p-6 rounded-xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all duration-300 hover:scale-105">
              <Rocket className="h-12 w-12 text-indigo-600 mx-auto mb-4" />
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Automatización</h3>
              <p className="text-gray-600 dark:text-gray-400">Optimiza tu tiempo y aumenta tu productividad</p>
            </div>
          </div>
        </div>
      </div>
